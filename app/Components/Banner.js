...
export default function Banner() {
  return (
    ...
    >
      <div className="w-full flex items-center px-4">
        {/* Left Text Content */}
        <div className="text-white ml-[20px] md:ml-[92px] max-w-full md:max-w-[1305px] space-y-6 px-2 sm:px-4">
          {/* Top Label */}
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
              <path d="M6 2a1 1 0 00-.894.553l-4 8A1 1 0 001 11h3.382l-.723 2.447a1 1 0 001.894.606L6.618 11H10a1 1 0 00.894-1.447l-4-8A1 1 0 006 2z" />
            ...
            <span className="text-[16px] md:text-[20px] font-medium">Built for Everyday Users</span>
          </div>

          {/* Heading */}
          <h1 className="text-[36px] sm:text-[48px] md:text-[80px] font-bold leading-tight">
            Seamless Guidance <br className="hidden sm:block" /> for Printer Glitches
          </h1>

          {/* Paragraph */}
          <div className="w-full max-w-[715px] mb-[30px] md:mb-[53px]">
            <p className="text-base sm:text-lg text-white/90">
              From paper jams to Wi-Fi glitches, Micro Hub Care offers clear, step-by-step guidance to help you get your printer back on track. No confusing jargon—just real solutions you can try at home.
            </p>
          </div>
